<template>
  <section class="mt-20 lg:mt-0 w-full relative text-white flex justify-center">
    ...
    <ul
      ref="statsSection"
      class="relative z-10 p-6 mx-auto w-11/12 lg:mx-0 rounded-3xl 
      border dark:bg-[#ffffff29] bg-primary shadow-lg md:divide-x grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8
      lg:gap-12 border-secondary divide-secondary"
    >
...
const numbers = ref([
  { id: 1, number: 1, title: 'Created Projects' },
  { id: 2, number: 2, title: 'Created Projects' },
  { id: 3, number: 122, title: 'Created Projects' },
  { id: 4, number: 123, title: 'Created Projects' },
])
