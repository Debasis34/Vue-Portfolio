<template>
  ...
  data-aos="zoom-out" class="flex justify-center items-center dark:text-white min-h-screen mt-20 lg:mt-0">
    ...
    <header class="absolute w-1/2 aspect-[16/5] -skew-x-12 
      rounded-full bg-gradient-to-r from-[#00c6cc] via-[#785ae4] to-secondary 
    ...
    <main class="absolute grid lg:grid-cols-2 grid-cols-1 items-center p-2 lg:p-8">
      <header class="text-center lg:text-left">
        ...
        <p class="text-lg max-w-xl mx-auto lg:mx-0 font-semibold">
          bala lekha lekhi kn gote rahiba 
        </p>

        <div class="mt-6 flex justify-center lg:justify-start"> 
          <Button label="Hire Me"/>
           <a href="" class="font-semibold text-lg w-[10rem] h-[55px] dark:text-secondary
            rounded-full ml-2 border-2 dark:border-secondary hover:scale-105
             bg-white dark:bg-transparent flex justify-center items-center text-primary border-primary">
      ...
      <aside class="container flex justify-center lg:justify-end mt-20 lg:mt-0 items-center
      flex-wrap">
    <figure class="card relative m-[30px] md:w-[420px] md:h-[420px] 
    md:before:w-[450px] md:before:h-[450px] w-[280px] h-[350px] 
    before:w-[300px] before:h-[300px] before:border-[25px] before:border-secondary 
    ...
    <svg class="hidden">
      <filter id="wavy1">
        <feTurbulence x="0" y="0" base-frequency="0.2" numOctaves="5"
        seed="1"></feTurbulence>
