<template>
  <div class="relative overflow-hidden bg-[#D4EBF8] dark:bg-[#080326] min-h-screen">
    <Suspense>
      <!-- Default slot: wrap all components inside a single root div -->
      <template #default>
        <div>
          <Navbar />
          <HeroSection />
      ...
      <!-- Fallback slot: show a loading spinner while async components load -->
      <template #fallback>
...
// Regular import for LoadingSpinner (not async)
